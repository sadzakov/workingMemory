...
public class House implements Screen {
    ...
    void createWordpic() {
        wordPics = new WordPics(world, "house");
        wordPics.setPosition(0, 0);
    }

    void createBtn() {
        btnH = new Image(new Texture("letters/letterh.jpg"));
        btnH.setSize(85f, 85f);
        ...
        btnS = new Image(new Texture("letters/letters.jpg"));
        btnS.setSize(85f, 85f);
    ...
    void setBtnPosition() {
        ...
        switch (option) {
            case 1:
                btnH.setPosition(GameInfo.WIDTH / 2f - DISTANCE_195, GameInfo.HEIGHT / 2f - 20, Align.center);
                btnS.setPosition(GameInfo.WIDTH / 2f - DISTANCE_100, GameInfo.HEIGHT / 2f - 20, Align.center);
            ...
            case 2:
                ...
                btnH.setPosition(GameInfo.WIDTH / 2f, GameInfo.HEIGHT / 2f - 20, Align.center);
                btnS.setPosition(GameInfo.WIDTH / 2f + DISTANCE_100, GameInfo.HEIGHT / 2f - 20, Align.center);
            ...
            case 4:
                btnE.setPosition(GameInfo.WIDTH / 2f - DISTANCE_195, GameInfo.HEIGHT / 2f - 20, Align.center);
                btnH.setPosition(GameInfo.WIDTH / 2f - DISTANCE_100, GameInfo.HEIGHT / 2f - 20, Align.center);
                btnS.setPosition(GameInfo.WIDTH / 2f, GameInfo.HEIGHT / 2f - 20, Align.center);
                btnO.setPosition(GameInfo.WIDTH / 2f + DISTANCE_100, GameInfo.HEIGHT / 2f - 20, Align.center);
                btnU.setPosition(GameInfo.WIDTH / 2f + DISTANCE_195, GameInfo.HEIGHT / 2f - 20, Align.center);
                break;
            case 5:
                btnS.setPosition(GameInfo.WIDTH / 2f - DISTANCE_195, GameInfo.HEIGHT / 2f - 20, Align.center);
                btnU.setPosition(GameInfo.WIDTH / 2f - DISTANCE_100, GameInfo.HEIGHT / 2f - 20, Align.center);
    ...
    void addListeners() {
        btnH.addListener(new ClickListener(){
            public void clicked(InputEvent event, float x, float y) {
                btnH.addAction(Actions.fadeOut(0.5f));

                Answer h = new Answer(world, "h");
                answerArray.add(h);
        ...
        btnS.addListener(new ClickListener(){
            public void clicked(InputEvent event, float x, float y) {
                btnS.addAction(Actions.fadeOut(0.5f));

                Answer s = new Answer(world, "s");
                answerArray.add(s);
